...
library(tidyr)
data2<-select(data,SubRegion, tagNum, PostCTGrazing, PostCTMacroboring, PostCTAccretion)
...
bmubar = ggplot(data = data3, aes(x=SubRegion, y=carbAmount, fill=bmuAttribute))+
